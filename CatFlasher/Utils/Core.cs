using CatFlasher.Utils.Flasher;
...
namespace CatFlasher.Utils
{
    public class Core
    {
        ...
        {
            var fblockState = (byte)(args.DisableFBLOCK ? 0 : 1); //0->lock 1->unlock
        ...
        public void StartProcess(FlashArgs args)
        {
